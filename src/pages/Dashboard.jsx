...
const pVariants = {
  visible: { x: 0, opacity: 1, transition: { duration: 1.4, delay: 1 } },
  hidden: { x: "-100%", opacity: 0 },
};
const btnVariants = {
  visible: { x: 0, opacity: 1, transition: { duration: 1.4, delay: 2.5 } },
  hidden: { opacity: 0 },
};

const imgVariants = {
  visible: {opacity: 1, transition: {duration: 1, delay: 2.2}},
  hidden: {opacity: 0}
}
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
            <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
              <motion.h1
                ...
                animate={controls}
                variants={h1Variants}
                className="mt-14 text-6xl font-bold leading-14 tracking-tight text-amber-500 sm:text-8xl sm:leading-24"
              >
                Welcome to <br />
                Dwello
              </motion.h1>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              {primaryFeatures.map((feature, index) => (
                <motion.div
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                  transition={{ delay: 1.5 + index, duration: 1 }}
                  viewport={{ once: true }}
                  key={feature.name}
                ...
                >
                  <motion.dt
                    ...
                    // transition={{ delay: 1.5 + index, duration: 1 }}
                    // viewport={{ once: true }}
                    className="text-base font-semibold leading-7 text-amber-950"
                  >
                    <motion.div
                      // initial={{ opacity: 0 }}
                      // whileInView={{ opacity: 1 }}
                      // transition={{ delay: 1.5 + index, duration: 1 }}
                      // viewport={{ once: true }}
                      className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-amber-500"
                    >
                      <feature.icon
